...
class CasesResource:
    ...
    def evidence(self, id: str) -> dict[str, Any]:
        """Fetch normalized case evidence: case, runs, nodes, events, actors, outcome."""
        return self._http.get(f"/v1/cases/{id}/evidence")

    def list_events(self, id: str) -> dict[str, Any]:
        """List lightweight workflow events attached to this case."""
        return self._http.get(f"/v1/cases/{id}/events")
